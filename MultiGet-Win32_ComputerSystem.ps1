...
#
#.Example 
#    get-content .\hosts.txt | MultiGet-Win32_ComputerSystem | export-csv Get-Win32_ComputerSystem_Multi.csv
#
#.Notes 
# Updated: 2016-10-24
...
Function MultiGet-Win32_ComputerSystem() {
	[cmdletbinding()]
	...
	PROCESS{
		...
		CATCH{
			Add-Content -Path .\MultiGet-Win32_ComputerSystem_errors.txt -Value ("$thisHost");
		}
	};
};
