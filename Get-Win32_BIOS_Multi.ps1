...
#
#.Example 
#    get-content .\hosts.txt | Get-Win32_BIOS_Multi | export-csv .\Get-Win32_BIOS_Multi.csv
#
#.Notes 
# Updated: 2016-10-21
...
Function Get-Win32_BIOS_Multi() {
	...
	PROCESS{
		...
		CATCH{
			Add-Content -Path .\Get-Win32_BIOS_Multi_errors.txt -Value ("$thisHost");
		}
	};
};
