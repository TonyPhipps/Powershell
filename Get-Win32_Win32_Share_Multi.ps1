...
#
#.Example 
#    get-content .\hosts.txt | Get-Win32_Share_Multi | export-csv Get-Win32_Share_Multi.csv
#
#.Notes 
# Updated: 2016-10-21
...
Function Get-Win32_Share_Multi() {
	[cmdletbinding()]
	...
	PROCESS{
		...
		CATCH{
			Add-Content -Path .\Get-Win32_Share_Multi_errors.txt -Value ("$thisHost");
		}
	};
};
