...
#
#.Example 
#    get-content .\hosts.txt | MultiGet-Win32_OperatingSystem | export-csv Get-Win32_OperatingSystem_Multi.csv
#
#.Notes 
# Updated: 2016-10-24
...
Function MultiGet-Win32_OperatingSystem() {
	[cmdletbinding()]
	...
	PROCESS{
		...
		CATCH{
			Add-Content -Path .\MultiGet-Win32_OperatingSystem_errors.txt -Value ("$thisHost");
		}
	};
};
